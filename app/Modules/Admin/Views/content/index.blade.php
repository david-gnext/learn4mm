...
<nav class="w3-container w3-topbar w3-pale-green">
    <a class="w3-btn w3-padding-16 w3-white disabled" id="content_add" title="Create Content"><i class="fa fa-plus-circle"></i></a>
</nav>
...
<table class="w3-table w3-bordered w3-border manage-table">
    ...
    <tbody>
        ...
        foreach($dbstatus["major"]["data"] as $m) {
            ...
            echo "<td><button type='button' class='w3-button w3-indigo select'>Select</button><input type='hidden' value='$m->id' class='edit-major-id'></td></tr>";
        }
        ?>
    </tbody>
</table>
